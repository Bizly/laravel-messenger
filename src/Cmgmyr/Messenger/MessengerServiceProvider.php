...
class MessengerServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        if ($this->app->runningInConsole()) {
            $this->publishes([
                base_path('vendor/bizly/messenger/src/config/config.php') => config_path('messenger.php'),
            ], 'config');

            $this->publishes([
                base_path('vendor/bizly/messenger/src/migrations') => base_path('database/migrations'),
            ], 'migrations');
        }
    ...
    public function register()
    {
        $this->mergeConfigFrom(
            base_path('vendor/bizly/messenger/src/config/config.php'), 'messenger'
        );
    }
